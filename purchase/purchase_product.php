  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Purchase Date</th>
          <td>
            <input class="form-control" type="date" name="pur_date" value="<?php echo $tdate; ?>" >
          </td>
  </tr>
     <tr>
...
<script>
  //after selecting company, supplier of that company will be show 
  var $com_id = $( '#com_id' ),
      $sup_id = $( '#sup_id' ),
...
/*nicher line ta parchase ar jonno selling price tak minimum set kore dai, 
  that means selling price must be equal or grater than purchase price  
*/    
...
//loop for total price using class name total_amount
  function fun1(){
    var total=0;
    ...
    //calculate the 4 rows
    //now discount and payment
    discount2();
    payment2();
  }
  ...
  function discount2(){
    ...
    if(total==''){total=0;}
    //total_discount dhorbo, ata tk ba perchantage hote pare
...
//100% ar bese discount dea jabe na 
  function discount3(){
